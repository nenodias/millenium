...
class MyPDF(FPDF):
    ...
    def __init__(self, dados):
        ...
        veiculo += ' - Ano: ' + ano
        veiculo += ' - Km: ' + '%.0f' % (
            to_float_or_zero(dados['vistoria']['kilometragem'])
        )
        self.veiculo = veiculo
        self.data = format_date(
            from_str_to_datetime_or_none(dados['data'])
        )
    ...
    def header(self):
        ...
        self.cell(
            w=100, h=4, txt=self.oficina.endereco, border=0, ln=0, align='L'
        )
        self.ln(4)
        ...
        self.cell(
            w=80,
            h=4,
            txt='Fone: %s' % (self.oficina.telefone),
            border=0,
            ln=0,
            align='L'
        )
        self.cell(
            w=80,
            h=4,
            txt='Celular: %s' % (self.oficina.celular),
            border=0,
            ln=0,
            align='L'
        )
        ...
        self.cell(
            w=100,
            h=4,
            txt='E-mail: %s' % (self.oficina.email),
            border=0,
            ln=0,
            align='L'
        )
    ...
    def draw_servicos(self):
        ...
        if self.servicos:
            ...
            self.cell(
                w=30,
                h=6,
                txt='%.2f' % (self.sub_total_servicos),
                border=0,
                ln=6,
                align='R'
            )
        ...
        self.cell(
            w=35, h=6, txt='%.2f' % (self.total), border=0, ln=6, align='R'
        )
        self.ln(1)
